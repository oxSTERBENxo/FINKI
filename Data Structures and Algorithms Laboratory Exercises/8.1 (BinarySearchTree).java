...
ќе најдете на која длабочина се наоѓа елементот T во дрвото. Ќе треба да ја искористите таа функција Q пати при градењето на дрвото.
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n + q; i++) {
            ...
            if (input[0].equals("insert")) {
                ...
                System.out.println(dlabocina(tree,tree.getRoot(),Integer.parseInt(input[1])));
            }
        }
    }

    static int dlabocina(BinarySearchTree<Integer> tree, BNode<Integer> curr, int key) {
        if (curr == null) {
            return 0;
        }
        if(curr.info==key){
            ...
            return 1 + dlabocina(tree, curr.left, key);
        }else {
            return 1 + dlabocina(tree, curr.right, key);
        }
